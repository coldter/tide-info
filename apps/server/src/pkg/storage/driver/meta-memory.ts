...
/** biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: complex logic */
/** biome-ignore-all lint/style/useBlockStatements: block statements */
/** biome-ignore-all lint/performance/useTopLevelRegex: regex */
// https://github.com/sandros94/unjs.unstorage/blob/dfcf48b54d1c275ab5131fe2cd83520deb471d7e/src/drivers/memory-meta.ts
